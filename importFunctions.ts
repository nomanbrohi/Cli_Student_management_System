...
const std_details:{student_name:string, father_name:string, age:number, ID:string, enrolled_courses:[],tution_fee:number }[]=[];
...
async function total_fee():Promise<number>{
