...
const enrollCourse: any = {Python:2000, JavaScript:4000, "C++":1500, Nextjs:4000, ReactJs:3000, "Data Science": 6000};
...
const generatedUniqueId = () :string =>{
    id++;
        ...
        if (question === "Add New")
            {
                const student_detail = await inquirer.prompt(
                    ...
                    student_detail.courses.forEach((course:string) =>{
